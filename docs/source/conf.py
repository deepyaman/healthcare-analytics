...
# healthcare_analytics documentation build
...
from healthcare_analytics import __version__ as release
...
htmlhelp_basename = "healthcare_analyticsdoc"
...
latex_documents = [
    (
        master_doc,
        "healthcare_analytics.tex",
        "healthcare_analytics Documentation",
        "QuantumBlack",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "healthcare_analytics",
        "Project healthcare_analytics codebase.",
        "Data-Science",
    )
]
